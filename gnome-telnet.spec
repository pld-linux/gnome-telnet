...
Summary(pl.UTF-8):   GNOME Telnet jest nakładką dla GNOME do programów Telnet, SSH oraz RLogin
Name:		gnome-telnet
Version:	2.4
Release:	1
License:	GPL
...
GNOME Telnet jest potężną nakładką na programy telnet, ssh oraz rlogin
